     ...
     <section className="w-full bg-white py-14 flex justify-center">
      ...
      >
        ...
        <div className="md:w-5/12 w-full flex-shrink-0 flex items-stretch">
          <img
            src="./image.jpg" // Use your actual Software Engineering image path
        ...
        <div className="flex-1 flex flex-col justify-center px-8 md:px-14 py-10">
          <h2 className="text-4xl font-montserrat font-semibold text-black text-left mb-0 leading-tight">
            Our Solutions for<br/> <span className="text-[#e5462e] font-extrabold">Software Engineering</span>
          </h2>
          ...
          <p className="text-gray-700 text-base md:text-lg mb-4 text-left">
            Stellar Innovations specializes in high-quality software development across the entire lifecycle.
          </p>
          <ul className="text-black/80 text-base md:text-lg mb-1 space-y-2 text-left">
            <li>
              80% of digital leaders prioritize custom software solutions.
            </li>
            <li>
              Up to 50% faster delivery with agile development methodologies.
            </li>
          </ul>
        </div>
      </motion.div>
...
<section className="w-full py-12 bg-white">
  <div className="max-w-6xl mx-auto">
    <h3 className="text-4xl font-montserrat font-semibold text-center mb-12">
      Key <span className="text-[#e5462e] font-extrabold">Outcomes </span>
    </h3>
    <motion.div
        ...
        <PixelTransition
          ...
          secondContent={
            <div className="rounded-2xl bg-[#585656]/90 flex flex-col items-center justify-center px-4 pt-10 pb-6 min-h-[130px]">
              ...
              <span className="text-white/95 block text-base text-center">software
development
time by 40%
</span>
            </div>
        ...
        <PixelTransition
          ...
          secondContent={
            <div className="rounded-2xl bg-[#585656]/90 flex flex-col items-center justify-center px-4 pt-10 pb-6 min-h-[130px]">
              ...
              <span className="text-white/95 block text-base text-center">customer
satisfaction by
25%</span>
            </div>
          }
