...
export default function Aiml() {
  return (
    <main className="font-montserrat bg-[#e5e7eb] w-full">
      ...
      {/* Background Image */}
      <img
        src="./LLM.webp" // <-- Your actual hero background image
        alt="Hero"
  ...
  >
    ...
    <div className="flex-1 flex flex-col justify-center px-8 md:px-14 py-10">
      ...
      <p className="text-lg md:text-xl font-bold text-black mb-3 text-left">
        Harness Intelligence for Enhanced Decision-Making
      </p>
      <p className="text-gray-700 text-base md:text-lg mb-4 text-left">
        Stellar Innovations offers cognitive services that leverage AI and ML to extract actionable insights, personalize customer experiences, and drive growth.
      </p>
      <ul className="text-black/80 text-base md:text-lg mb-1 space-y-2 text-left">
        <li>
          <span className="font-bold">60%</span>  of businesses leveraging AI report better customer experiences.
        </li>
        <li>
          <span className="font-bold">85%</span>increase in data-driven decision-making with AI integration.
        </li>
      </ul>
    </div>
  </motion.div>
  ...
  <div className="max-w-6xl mx-auto text-center">
    <h3 className="text-3xl md:text-4xl font-bold mb-12">
      Our <span className="text-[#e5462e]">Offerings</span>
    </h3>
    <div className="flex flex-col md:flex-row items-center justify-center gap-10">
      ...
      >
        ...
        <div className="flex flex-col justify-center items-start px-6 py-8 rounded-2xl bg-gray-100 shadow text-left">
          ...
          <span className="font-extrabold text-lg text-black">Natural Language</span>
          <span className="text-gray-700 text-lg font-medium"> Processing</span>
        </div>
        ...
        <div className="flex flex-col justify-center items-start px-6 py-8 rounded-2xl bg-[#585656] shadow text-left">
          ...
          <span className="font-extrabold text-lg text-white">Predictive</span>
        ...
        <div className="flex flex-col justify-center items-start px-6 py-8 rounded-2xl bg-[#373535] shadow text-left col-span-2 md:col-span-1">
          ...
          <span className="font-extrabold text-lg text-white">Image and Video</span>
          <span className="text-white text-lg font-medium">Analysis</span>
        </div>
      </motion.div>
    </div>
  </div>
        ...
        <PixelTransition
          ...
          secondContent={
            <div className="rounded-2xl bg-[#585656]/90 flex flex-col items-center justify-center px-4 pt-10 pb-6 min-h-[130px]">
              <span className="font-extrabold text-lg mb-1 block">Enhanced</span>
              <span className="text-white/95 block text-base text-center">customer engagement by 50%</span>
            </div>
          }
          gridSize={12}
        ...
        <PixelTransition
          ...
          secondContent={
            <div className="rounded-2xl bg-[#585656]/90 flex flex-col items-center justify-center px-4 pt-10 pb-6 min-h-[130px]">
              ...
              <span className="text-white/95 block text-base text-center">operational errors by 30%</span>
            </div>
          }
          gridSize={12}
          animationStepDuration={0.5}
